...
import Electric from "./components/elbahja/Electric";
import FactureUser from "./components/elbahja/FactureUser"
              ...
              <div className="row">
                <div className="col-lg-12">
                  ...
                  <Switch>
                    ...
                    <Route path="/facture-electricity/:id" component={FactureUser} />
                  </Switch>
                </div>
              </div>
            </div>
