      ...
      <ul className="sidebar-nav">
        ...
        {user && (
          <React.Fragment>
            ...
            <Dropdown >
            <Dropdown.Toggle variant="success" id="dropdown-basic" style={{background:"black"}}>
              Electr-water
            </Dropdown.Toggle>

            <Dropdown.Menu style={{background:"black"} }>
              <Dropdown.Item href="/electric">electricity</Dropdown.Item>
            ...
            <li>
              <NavLink to="/Recharge">
              <i className="fa fa-home" aria-hidden="true"></i>  Recharge
              </NavLink>
            </li>

            <li>
              <NavLink to="/car">
              <i className="fa fa-home" aria-hidden="true"></i>  Assurance Car
              </NavLink>
            </li>

            <li>
              <NavLink to="/school">
              <i className="fa fa-home" aria-hidden="true"></i> School
              </NavLink>
            </li>
